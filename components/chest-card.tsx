...
const effectMeta: Record<ChestEffect, { label: string; svg: string; rarity: 'trash' | 'common' | 'rare' | 'epic'; tagline: string }> = {
  ...
  CANT_PASS_THOMAS: { label: "Can't Pass Thomas", svg: '/assets/v2/chest-open.svg', rarity: 'trash', tagline: 'Legacy effect đã ngưng roll mới' },
  ...
  MORE_PEOPLE_MORE_FUN: { label: 'More People More Fun', svg: '/assets/v2/chest-open.svg', rarity: 'common', tagline: 'Race sau có đúng 3 người thua' },
