...
const specs: Record<string, {
  ...
  DUO: { icon: '🤝', label: 'DUO', rule: 'Cặp có tổng thứ hạng tệ nhất cùng bị làm dzịt.', tone: 'from-violet-400/35 via-violet-950/50 to-black/20', accent: 'text-[var(--color-ggd-lavender)]', },
  ...
  CONSTRUCTORS: { icon: '🏎️', label: 'CONSTRUCTORS', rule: 'Đội có tổng thứ hạng tệ hơn cùng bị làm dzịt.', tone: 'from-yellow-400/35 via-yellow-950/55 to-black/20', accent: 'text-[var(--color-ggd-gold)]', },
