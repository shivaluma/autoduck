        ...
        <div className="flex flex-wrap justify-center gap-1 px-2">
          {visibleLegacy.map((_, index) => (
            <div
              ...
              title={`Khiên legacy #${index + 1}: chưa có record Shield riêng trên DB prod, tạm xem là 0 tuần chưa dùng. Nên backfill Shield để hệ decay theo dõi chính xác ngày vỡ.`}
            >
              <Image
                src="/assets/v2/shield-fresh.svg"
