...
export const LOADOUT_CONFIG = {
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Bắn tên lửa tầm nhiệt nhắm đối thủ phía trước, triệt tiêu ngay tăng tốc và hãm tốc độ còn 30% trong 1.2s.',
    },
    {
      id: 'DRAFT_FIN',
      name: 'Draft Fin',
    ...
    },
    {
      ...
      category: 'minor' as const,
      itemClass: 'DEFENSE' as const,
      description: 'Áo giáp chống sốc (Nội tại), giảm 50% thời gian/mức hãm tốc từ Tên Lửa và giảm 60% lực đẩy từ Còi Quack Horn.',
    },
    {
      id: 'BANANA',
      name: 'Banana',
