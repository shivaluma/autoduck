...
export const RACE_ITEM_CATALOG: readonly RaceItemDefinition[] = [
  ...
  { id: 'SHOCK_ABSORBER', name: 'Shock Absorber', icon: '🦺', cost: 1, category: 'minor', itemClass: 'DEFENSE', description: 'Áo giáp chống sốc (Nội tại), giảm 60% phản lực nổ giật lùi và 50% thời gian hãm tốc từ Tên Lửa, giảm 60% lực đẩy từ Còi Quack Horn.' },
  { id: 'HOMING_ROCKET', name: 'Homing Rocket', icon: '🚀', cost: 2, category: 'major', itemClass: 'ATTACK', description: 'Bắn tên lửa tầm nhiệt nhắm đối thủ phía trước, triệt tiêu tăng tốc, nổ tung giật lùi 4% quãng đường và hãm xoay vòng trong 1.4s (1 lần/trận).' },
